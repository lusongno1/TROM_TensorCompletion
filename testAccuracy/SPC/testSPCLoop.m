...
%rho     = [RES0.001,0.001,0.001,0.001,0.001,0.001];
rho     = zeros(1,6);
%rh = 0.5;
...
%%
RES(end+1,1:2) = [min(ERR(:,1)) min(ERR(:,4))];
saveas(gcf,['res' num2str(sz(1)) 'D' num2str(sz(2)) num2str(sz(3)) ...
    num2str(sz(4)) num2str(sz(5)) 'T' num2str(sz(6)) num2str(rh) '.png'])
%save('vars.mat')
end
RES
save('RES.txt','RES','-ascii','-tabs')
writematrix(RES,'RES.txt','Delimiter','tab')
